...
folder_path = "/Users/rita/Thesis/Survey/Data From Sites/Analysis/All Sites/"

# Input filtered CSV file name
filtered_filename = "output_combined.csv"  # Replace with the actual file name
...
fig.update_layout(
    title_text="Species of All Bats Recorded",
    title_x=0.55,  # Title alignment
